#Collect the UBER fare data for OD pairs which lie in timezone 10
#Importing Packages
import requests
import json
import sys
...
def getLocList(startid,endid):
    ...
    conread = sqlite3.connect("/home/bt2/14CS10061/shaiwal/Uber/ByTimezone/dataset/sqlite/zone10_loc.sqlite")
...
def main():
	...
	outfilename = '/home/bt2/14CS10061/shaiwal/Uber/ByTimezone/10/uber/10uberprice_key'+str(keyid)+'_sid'+str(idlow)+'_eid'+str(idhi)+'.json.gz'
