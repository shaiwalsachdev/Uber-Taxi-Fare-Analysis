...
def getLocList(startid,endid):
    ...
    conread = sqlite3.connect("/home/bt2/14CS10061/shaiwal/Uber/dataset/testlocation10000.sqlite")
...
def main():
	...
	outjsonfile = '/home/bt2/14CS10061/shaiwal/Uber/code/api_keys1.json'
	...
	outfilename = '/home/bt2/14CS10061/shaiwal/Uber/output/uberprice_key'+str(keyid)+'_sid'+str(idlow)+'_eid'+str(idhi)+'.json.gz'
